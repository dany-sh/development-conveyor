...
PORTFOLIO_TRANSITIONS = {
    ...
    "feature_running": {"queue_reconciliation", "feature_review", "feature_accepted", "feature_ready", "milestone_gate", "repository_dirty", "validation_failed", "architecture_decision_required", "destructive_change_required", "human_decision_required", "conveyor_error", "paused"},
    ...
    "feature_accepted": {"queue_reconciliation", "feature_ready", "milestone_gate", "validation_failed", "human_decision_required", "conveyor_error", "paused"},
