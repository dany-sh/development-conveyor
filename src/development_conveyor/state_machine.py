...
CYCLE_STATES = (
    ...
    "feature_review", "feature_repair", "feature_accepted", "integration_pending", "integration_ready",
...
PORTFOLIO_TRANSITIONS = {
    ...
    "integration_pending": {"queue_reconciliation", "integration_ready", "integrating", "integration_blocked", "human_decision_required", "validation_failed", "paused"},
    "integration_ready": {"integrating", "integration_blocked", "human_decision_required", "validation_failed", "paused"},
    "integrating": {"integration_validation", "integration_blocked", "feature_integrated", "human_decision_required", "validation_failed", "paused"},
    "integration_validation": {"feature_integrated", "integration_blocked", "human_decision_required", "validation_failed", "paused"},
    "integration_blocked": {"human_decision_required", "queue_reconciliation", "paused"},
    "feature_integrated": {"queue_reconciliation", "feature_ready", "milestone_gate", "paused"},
    "milestone_gate": {"queue_reconciliation", "milestone_ready_for_merge", "validation_failed", "architecture_decision_required", "human_decision_required", "conveyor_error", "paused"},
...
CYCLE_TRANSITIONS = {
    ...
    "integration_pending": {"integration_ready", "integrating", "human_decision_required", "failed"},
    "integration_ready": {"integrating", "human_decision_required", "failed"},
    ...
    "human_decision_required": {"preflight", "branch_preparing", "feature_in_progress", "integration_pending", "integration_ready", "integrating", "milestone_gate", "failed"},
